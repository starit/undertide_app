  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-12 md:px-8 md:py-16">
      <SectionHeading
        ...
        description="Search verified governance spaces by category, activity, or follower scale, then drill into protocol-specific proposal streams. The initial view is capped to a fast, curated slice."
      />
      <div className="mt-10">
